...
export default function ProviderLimits() {
  ...
  // New API rows carry their own persisted label; static providers use the
  // registry name. Both paths avoid leaking a generated internal provider id.
  ...
  const selectedProviderLabel = providerFilter === "all"
    ? "All providers"
    : selectedProvider?.label || providerLabel(providerFilter);
